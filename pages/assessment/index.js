...
Page({
  ...
  playVoice: function (e) {
    ...
    console.log("play_path", play_path)
     ...
     var pl = wx.getSystemInfoSync()
    console.log("pl.platform", pl.platform)
     if (pl.platform == 'android') {
      this.playAnimationStart()
      wx.playBackgroundAudio({
        dataUrl: e.currentTarget.dataset.voice,
        title: 'w12',
        coverImgUrl: '',
        success: (res) => {
  ...
  // },
    ...
    //     const bac = wx.createInnerAudioContext();
    //     bac.src = play_path;
    //     bac.title = 'word';
    //     bac.coverImgUrl = '';
    //     bac.play();
